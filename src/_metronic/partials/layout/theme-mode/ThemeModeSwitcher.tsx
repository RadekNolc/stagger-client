      ...
      >
        ...
        <div className='menu-item px-3 my-0'>
          ...
          >
            ...
            <span className='menu-title'>{intl.formatMessage({id: "THEME.MODE.LIGHT"})}</span>
          </a>
        </div>
        {/* end::Menu item */}
        ...
        <div className='menu-item px-3 my-0'>
          ...
          >
            ...
            <span className='menu-title'>{intl.formatMessage({id: "THEME.MODE.DARK"})}</span>
          </a>
        </div>
        {/* end::Menu item */}
        ...
        <div className='menu-item px-3 my-0'>
          ...
          >
            ...
            <span className='menu-title'>{intl.formatMessage({id: "THEME.MODE.SYSTEM"})}</span>
          </a>
        </div>
        {/* end::Menu item */}
      </div>
